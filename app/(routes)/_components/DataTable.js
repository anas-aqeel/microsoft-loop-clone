...
const DataTable = ({ dataList, onClickFunc, options, type = "table", loading }) => {
                ...
                (<div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 2xl:grid-cols-4 gap-8 place-content-start'>
                    {(
                        ...
                        Array.from({ length: 4 }).map((_, index) => (
                            <div key={index} className='shadow-xl rounded-lg animate-pulse bg-gray-200 '>
                                <div className='w-full h-48 rounded-t-lg'></div>
                                <div className='mt-2 flex justify-between px-2 py-3'>
                                    <div className='text-sm flex items-center w-3/4'>
                                        <div className='bg-gray-400 h-4 w-6 rounded-full'></div>
                                        <div className='ml-2 bg-gray-400 h-4 w-20 rounded'></div>
                                    </div>
